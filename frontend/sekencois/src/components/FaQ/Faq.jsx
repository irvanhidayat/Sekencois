  ...
  const faqs = [
    ...
    },
    {
      ...
      questions: [
        ...
        // Tambahkan pertanyaan lain dalam kategori Pesanan dan Pengiriman
      ]
    },
  ];

  return (
    <div className="p-4 px-12 bg-gray-200">
